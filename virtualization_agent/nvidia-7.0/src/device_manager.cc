  ...
  if( payload.get_size() == 1) 
  {
    ...
    if( data_t == ARG_REAL )
    {
      if( t_size == sizeof(float) )
      {
        ...
        auto fin = (const float *) data;
        //GPU call
        h_pw_method(2, fin, rbuf, (float)1, size);
      ...
      else if( t_size == sizeof(double) )
      {
        ...
        auto rbuf = (double *) results;
        auto fin = (const double *) data;
        h_pw_method(2, fin, rbuf, (double)1, size);
      } 
      else std::cout << "real type size unsupported..." << std::endl;
    ...
    else if( data_t == ARG_INT )
    {
      if( t_size == sizeof(char) )
      {
        if( sign_t == ARG_UNSIGNED )
        {
          ...
          auto rbuf = (unsigned char *) results;
          auto fin  = (unsigned char *) data;
          h_pw_method(2, fin, rbuf, (unsigned char)1, size);
        }
        else
        {
          std::cout << "signed char..." << std::endl;
          auto rbuf = (char *) results;
          auto fin  = (char *) data;
          h_pw_method(2, fin, rbuf, (char)1, size);
        }
      ...
      else if( t_size == sizeof(int) ) 
      {
        if( sign_t == ARG_UNSIGNED )
        {
          ...
          auto rbuf = (unsigned int *) results;
          auto fin  = (unsigned int *) data;
          h_pw_method(2, fin, rbuf, (unsigned int)1, size);
        }
        else
        {
          std::cout << "signed int..." << std::endl;
          auto rbuf = (int *) results;
          auto fin  = (int *) data;
          h_pw_method(2, fin, rbuf, (int)1, size);
        }
      ...
      else if( t_size == sizeof(long) )
      {
        if( sign_t == ARG_UNSIGNED )
        {
          ...
          auto rbuf = (unsigned long *) results;
          auto fin  = (unsigned long *) data;
          h_pw_method(2, fin, rbuf, (unsigned long)1, size);
        }
        else
        {
          std::cout << "signed long..." << std::endl;
          auto rbuf = (long *) results;
          auto fin  = (long *) data;
          h_pw_method(2, fin, rbuf, (long)1, size);
        }
      ...
      else if( t_size == sizeof(long long) )
      {
        if( sign_t == ARG_UNSIGNED )
        {
          ...
          auto rbuf = (unsigned long long *) results;
          auto fin  = (unsigned long long *) data;
          h_pw_method(2, fin, rbuf, (unsigned long long)1, size);
        }
        else
        {
          std::cout << "signed long long..." << std::endl;
          auto rbuf = (long long *) results;
          auto fin  = (long long *) data;
          h_pw_method(2, fin, rbuf, (long long)1, size);
        }
  ...
  if( payload.get_size() == 1) 
  {
    ...
    if( data_t == ARG_REAL )
    {
      if( t_size == sizeof(float) )
      {
        ...
        auto fin = (const float *) data;
        //GPU call
        h_pw_method(3, fin, rbuf, (float)1, size);
      ...
      else if( t_size == sizeof(double) )
      {
        ...
        auto rbuf = (double *) results;
        auto fin = (const double *) data;
        h_pw_method(3, fin, rbuf, (double)1, size);
      } 
      else std::cout << "real type size unsupported..." << std::endl;
    ...
    else if( data_t == ARG_INT )
    {
      if( t_size == sizeof(char) )
      {
        if( sign_t == ARG_UNSIGNED )
        {
          ...
          auto rbuf = (unsigned char *) results;
          auto fin  = (unsigned char *) data;
          h_pw_method(3, fin, rbuf, (unsigned char)1, size);
        }
        else
        {
          std::cout << "signed char..." << std::endl;
          auto rbuf = (char *) results;
          auto fin  = (char *) data;
          h_pw_method(3, fin, rbuf, (char)1, size);
        }
      ...
      else if( t_size == sizeof(int) ) 
      {
        if( sign_t == ARG_UNSIGNED )
        {
          ...
          auto rbuf = (unsigned int *) results;
          auto fin  = (unsigned int *) data;
          h_pw_method(3, fin, rbuf, (unsigned int)1, size);
        }
        else
        {
          std::cout << "signed int..." << std::endl;
          auto rbuf = (int *) results;
          auto fin  = (int *) data;
          h_pw_method(3, fin, rbuf, (int)1, size);
        }
      ...
      else if( t_size == sizeof(long) )
      {
        if( sign_t == ARG_UNSIGNED )
        {
          ...
          auto rbuf = (unsigned long *) results;
          auto fin  = (unsigned long *) data;
          h_pw_method(3, fin, rbuf, (unsigned long)1, size);
        }
        else
        {
          std::cout << "signed long..." << std::endl;
          auto rbuf = (long *) results;
          auto fin  = (long *) data;
          h_pw_method(3, fin, rbuf, (long)1, size);
        }
      ...
      else if( t_size == sizeof(long long) )
      {
        if( sign_t == ARG_UNSIGNED )
        {
          ...
          auto rbuf = (unsigned long long *) results;
          auto fin  = (unsigned long long *) data;
          h_pw_method(3, fin, rbuf, (unsigned long long)1, size);
        }
        else
        {
          std::cout << "signed long long..." << std::endl;
          auto rbuf = (long long *) results;
          auto fin  = (long long *) data;
          h_pw_method(3, fin, rbuf, (long long)1, size);
        }
